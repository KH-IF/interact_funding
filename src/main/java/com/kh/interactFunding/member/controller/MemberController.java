		...
		try {
			...
			mp.addBodyPart(
					getContents("<div\r\n"
							...
							+ "  >\r\n"
							+ "    <img\r\n"
							+ "      src=\"https://kimyunsu-temp.s3.ap-northeast-2.amazonaws.com/iflogo3.jpeg\"\r\n"
							+ "      style=\"width: 120px; height: 50px\"\r\n"
							+ "    />\r\n"
							+ "    <h2 style=\"text-align: center\">\r\n"
							+ "      안녕하세요! No1.크라우드 펀딩\r\n"
							+ "      <u style=\"font-size: 30px; margin-top: 0\">이프</u> 입니다!\r\n"
							+ "    </h2>\r\n"
							+ "    <div style=\"margin-bottom: 10px\">\r\n"
							+ "      <div></div>\r\n"
							+ "      <div style=\"margin-bottom: 5px\">이프에 돌아오신걸 환영합니다.</div>\r\n"
							...
							+ "        지금 변경하시려면\r\n"
							+ "        <a\r\n"
							+ "          href=\""+url+"/member/newPassword?memberNo="+member.getMemberNo()+"&code="+code+"\"\r\n"
