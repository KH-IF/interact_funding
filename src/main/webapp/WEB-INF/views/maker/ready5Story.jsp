...
<jsp:include page="/WEB-INF/views/maker/common/makerNav.jsp" flush="false">
    ...
    <div class="container p-5">
        ...
        <p>메이커님의 프로젝트를 소개해보세요. 스토리에는 메이커님의 진심과 목소리가 잘 녹여질 수 있도록 명확하고, 솔직하게, 친근한 어투로 작성하세요.</p>
        
        <br>    
        <h6>소개 영상·사진 등록</h6>
        <p class="text-muted">프로젝트 페이지 상단에 노출될 영상 또는 사진을 올려주세요.</p>
        <br>
        ...
        <textarea class="form-control" aria-label="With textarea" id="basicRequireYes" placeholder="내용 입력" cols=""  rows="3" maxlength="100"></textarea>
        <!-- 몇 글자 남았는지 표시 -->
        <p>100자 남음</p>
        ...
        <h6>프로젝트 스토리</h6>
        <p class="text-muted">
            진정성 있고 매력적인 스토리로 서포터분들의 마음을 움직여 볼까요?
            스토리 필수 항목을 누락할 경우 오픈이 지연될 수 있으며, 제3자의 지식 재산권을 침해할 경우 프로젝트가 중단/취소될 수 있으니 유의해 주세요.
        </p>
