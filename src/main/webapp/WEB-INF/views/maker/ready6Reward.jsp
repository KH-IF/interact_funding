        ...
        <div id="makerRewardInsert" class="modal" tabindex="-1" role="dialog">
            ...
            <form name="rewardInsertFrm" ${pageContext.request.contextPath}/markerFuning/insertReward.do" method="post">
                ...
                <div class="modal-body" data-spy="scroll"  style="height: 500px;">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" maxlength="40" placeholder="타이틀 입력 ex)[얼리버드]기본 리워드" aria-label="Recipient's username" aria-describedby="basic-addon2">
                    </div>
                    <p>60자 남음</p>

                    <h6 class="font-weight-bold">상세설명</h6>
                    <div class="container">
                        <textarea class="form-control" aria-label="With textarea" id="basicRequireYes" placeholder="제공하는 리워드가 무엇인지 간략하게 제시해 주세요." cols=""  rows="3" maxlength="500"></textarea>
                        <!-- 몇 글자 남았는지 표시 -->
                        <p>400자 남음</p>
                    </div>
                    ...
                    <br>
                    <h6>배송조건</h6>
                    <div class="makerRewardShipPrice">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                            <input id="shipNeed" name="shipPriceYN" onchange="showShipPrice()" selected type="radio" aria-label="Radio button for following text input">
                            </div>
                            <label for="" class="text-muted">배송이 필요한 리워드 입니다.</label>
                        ...
                        <div id="shipPrice" class="input-group">
                            ...
                            <div>
                            <input type="text" style="width:100px" class="form-control" value="0" aria-label="Recipient's username" aria-describedby="basic-addon2">
                            </div>
                            <span class="p-1">원</span>
                            <div>
                                <p class="text-muted ml-4">(배송비가 없는 경우,0원 입력)</p>
                            </div>
                        </div>

                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="shipPriceYN" onchange="showShipPrice()" aria-label="Radio button for following text input">
                            </div>
                            <label for="">배송이 필요 없는 리워드입니다.</label>
                        </div>
                    </div>
         ...
         <div id="makerRewardUpdate" class="modal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document" >
            <div class="modal-content">
            <form name="rewardUpdateFrm" ${pageContext.request.contextPath}/markerFuning/updateReward.do" method="post">
                <div class="modal-header">
                    <p class="font-weight-bold">리워드 추가</p>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
