    ...
    <div id="makerGuide" class="modal" tabindex="-1" role="dialog">
        ...
        <div class="container p-5">
            ...
            <div class="border rounded p-3 ">
                ...
                <button type="button" class=" btn btn-outline-secondary btn-lg float-right" onclick="makerMovePage(charge)">
                    작성하기
                </button>
                <br>
                <br>
            ...
            <div class="border rounded p-3">
                <br>
                <p class="h3 d-inline">기본 요건</p> &nbsp;&nbsp; 
                <span class="d-inline">작성 전</span> 
                <button type="button" class=" btn btn-outline-secondary btn-lg float-right" onclick="makerMovePage(basicRequire)">
                    작성하기
                </button>
                <br>
                <br>
            ...
            <div class="border rounded p-3">
                ...
                <span class="d-inline">작성 전</span> 
                <button type="button" class=" btn btn-outline-secondary btn-lg float-right" onclick="makerMovePage(basicInfo)">
                    작성하기
                </button>
                <br>
                <br>
            ...
            <div class="border rounded p-3">
                ...
                <span class="d-inline">작성 전</span> 
                <button type="button" class=" btn btn-outline-secondary btn-lg float-right" onclick="makerMovePage(story)">
                    작성하기
                </button>
                <br>
                <br>
            ...
            <div class="border rounded p-3">
                ...
                <span class="d-inline">작성 전</span> 
                <button type="button" class=" btn btn-outline-secondary btn-lg float-right" onclick="makerMovePage(reward)">
                    작성하기
                </button>
                <br>
                <br>
...
<script>
    ...
    function makerMovePage(pagename){
        location.href=`${pageContext.request.contextPath}/makerFunding/${pagename}`;
    };
</script>
