...
<div id="funding_tap">
	<ol>
		...
		<li><a
			href="${pageContext.request.contextPath }/funding/supporter.do?funding_no=${funding.fundingNo}o">서포터</a>
		</li>
	</ol>
</div>
...
<script>
$("#nv-view-btn").click(() => {
	location.href = "${pageContext.request.contextPath}/funding/news.do?funding_no=${funding.fundingNo}"
});
